...
class MyNavbar extends Component {
    render() {
      ...
      <Dropdown.Toggle id="dropdown" bg="transparent" align="end">
        <img className="avatar-img mr-2" src="https://media.npr.org/assets/img/2020/10/06/gettyimages-74299482_wide-5ac106c73086aa63c495089c35f4811d0bb1ce5b.jpg" alt="" />
      </Dropdown.Toggle>
